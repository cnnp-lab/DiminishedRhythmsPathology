...
avg_power_table = readtable('../../../data/node_file_19h-1.3d_Delta_Cycle_power.csv');
...
plotBrain(regionDescriptions.lausanne120_aseg,avg_power,cm,'atlas','lausanne120',...
    'savePath', char(strcat('../../../data/plots/','figure1b_POW')),'limits', [0 max_value])
...
plotBrain(regionDescriptions.lausanne120_aseg,is_soz,cm,'atlas','lausanne120',...
    'savePath', char(strcat('../../../data/plots/','figure1b_SOZ')),'limits', [0 1])
